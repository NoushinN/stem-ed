...
Machine learning can be used for time series forecasting (investigate seasonality on any time scale) and natural language processing (word count, word embeddings to create features that group similar words).


Deep learning and AI requirements:
- prediction is more feasible than explanation
