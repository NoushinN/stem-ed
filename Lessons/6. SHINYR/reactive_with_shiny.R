###DEMO for SHINYR using reactive elements###
# Lessons are adapted and organized by Noushin Nabavi, PhD.
## nice reference: https://www.dshkol.com/2018/better-maps-with-vector-tiles/

# Shinyapp anatomy =  User interface + Server
...
n_total <- nrow(movies)
# another example of reactive elements
# UI
ui <- fluidPage(
  sidebarLayout(
