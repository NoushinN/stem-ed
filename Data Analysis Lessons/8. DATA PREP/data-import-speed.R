## This test script works on my MacBook running
## R3.6.0 & RStudio 1.2.1335 with all CRAN packages
## up-to-date

## Some of the test code does NOT work in the SAE,
## or it works with some software and not others
