...
### PYTHON FUNCTIONS ###\
\
# Familiar functions (e.g. type, len, int)\
...
get-pip.py\
pip3 install numpy # numeric python to do calculations over entire arrays\
\
