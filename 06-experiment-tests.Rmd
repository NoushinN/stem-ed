...
```{r str to view design, message= FALSE}
...
Examine missingness with miss_var_summary(): using library(naniar)
...
```{r plot residuals, message= FALSE}
par(mfrow = c(2,2))
